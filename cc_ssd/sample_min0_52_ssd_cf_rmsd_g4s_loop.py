...
def calculate_rmsd(cc_pose, af_pose, file, h1start, h1end, h2start, h2end, min_name):
    ...
    res_index_sel2_ref.set_index_range(start=h2start+5, end=h2end+5)
...
colab_outdir = '/wynton/home/kortemme/scrilly/helix_sliding/20230911_min0_52_ssd_G4S_loop_colabfold_array'
...
min1_df.to_csv(f"{outdir}/20231009_min0_52_df_all_outputs_g4s_loop.csv")
